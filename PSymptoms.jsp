											...
											<div class="row">
												<div class="col-md-4">
													<form name="frm" method="POST" action="">
														<label><small>Start Age</small></label> <select required
															name="age" id="age" class="form-control">
															<option value="0" selected style="color: rgb(255, 0, 0);">Select
																Age</option>
															<option value="Kid">Kid(0-5) years</option>
															<option value="Junior & Adolescent">Junior &
																Adolescent(6-16) years</option>
															<option value="Young Adult">Young Adult(17-29)
																years</option>
															<option value=Adult>Adult(30-64) years</option>
															<option value="Senior">Senior(65+) years</option>

														</select><br> <label><small>Gender</small></label> <select
															id="gender" name="gender" class="form-control">
															<option value="0" selected style="color: rgb(255, 0, 0);">Select
																Gender</option>
															<option value="Male">Male</option>
															<option value="Female">Female</option>
														</select><br> <label><small>Select symptoms
																from the list or Describe in your own words</small>
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
															&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														...
														<div id='TextBoxesGroup'>
															<div id="TextBoxDiv1">
																...
																<label>Symptom #1 : </label><input type='textbox'
																	id='sym1' placeholder="Enter symptom here." name="sym1"
																	class="form-control" list="somethingelse5">
																<datalist id="somethingelse5">
																	...
																	<option style="font-family: Arial"
																		value="<%=rs12.getString(1)%>"><%=rs12.getString(1)%></option>
														...
														<br> <input type="submit" name="Update" id="update1"
															value="Search" class="btn btn-primary" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input
															type="reset" name="clean" id="clean" value="Clear"
															class="btn btn-primary" />
													</form>
												</div>
												<br>
												...
												<div class="col-md-6">
													...
													<form name="frm" method="POST" action="">
														<table class="table table-bordered">
															...
															<tr>
																<td>#</td>
																<td class="text-center text-capitalize"><b>Likely
																		Diagnoses</b></td>
															</tr>
															...
															<tr class="nav nav-tabs">
																...
																<td style="background-color: white;">
																	<div class="form-inline text-center">
																		<input type="submit" name="Update" id="update2"
																			value="TOP 5" class="btn btn-info" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																		<input type="submit" name="Update" id="update"
																			value="ALL" class="btn btn-info" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
												...
												<script>
													function showHint() {
														if (str.length === 0) {
															document
																	.getElementById("display1").innerHTML = "";
															return;
														} else {
															var xmlhttp = new XMLHttpRequest();
															xmlhttp.onreadystatechange = function() {
																if (this.readyState === 4
																		&& this.status === 200) {
																	document
																			.getElementById("display1").innerHTML = this.responseText;
																}
															};
															xmlhttp
																	.open(
