                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
                                        <img src="images/images.jpg" class="img img-responsive" alt="" />
                                    </div><br><br><br>
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <div class="panel-body" style="margin-top: -50px;">
                                        ...
                                        <%
                                            ...
                                            out.println("<b>&nbsp;&nbsp;&nbsp;&nbsp;" + "[" + id + "]</b>");
                                        %></center>
                                    <center><img src="images/imageh.jpg" style="width: 100%" class="img img-responsive"></center><hr>
                                    <center><h1>Welcome To Student's Dashboard.</h1></center>
                                </div></div>
